...
class Config:
    APP_NAME = os.environ.get('APP_NAME') or 'Immigrant Defense Project'
    ...
    PARTNER_PASSWORD = os.environ.get('PARTNER_PASSWORD') or 'password'
    PARTNER_EMAIL = os.environ.get('PARTNER_EMAIL') or 'partner@idp.com'
